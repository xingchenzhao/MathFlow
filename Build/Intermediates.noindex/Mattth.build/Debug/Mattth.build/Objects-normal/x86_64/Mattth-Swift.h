...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Mattth",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC6Mattth11AppDelegate")
...
SWIFT_CLASS("_TtC6Mattth14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(Mattth)) <NSTableViewDataSource>
